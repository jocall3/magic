  ...
  paths: {
    ...
    "/users/password-reset/initiate": {
      post: {
        ...
        tags: ["users", "password-reset", "initiate"],
    ...
    "/users/password-reset/confirm": {
      post: {
        ...
        tags: ["users", "password-reset", "confirm"],
    ...
    "/users/me/biometrics/verify": {
      post: {
        ...
        tags: ["users", "me", "biometrics", "verify"],
    ...
    "/accounts/{accountId}/details": {
      get: {
        ...
        tags: ["accounts", "{accountId}", "details"],
    ...
    "/accounts/{accountId}/transactions/pending": {
      get: {
        ...
        tags: ["accounts", "{accountId}", "transactions", "pending"],
    ...
    "/accounts/{accountId}/statements": {
      get: {
        ...
        tags: ["accounts", "{accountId}", "statements"],
    ...
    "/accounts/{accountId}/overdraft-settings": {
      get: {
        ...
        tags: ["accounts", "{accountId}", "overdraft-settings"],
    ...
    "/transactions/{transactionId}/categorize": {
      put: {
        ...
        tags: ["transactions", "{transactionId}", "categorize"],
    ...
    "/transactions/{transactionId}/notes": {
      put: {
        ...
        tags: ["transactions", "{transactionId}", "notes"],
    ...
    "/transactions/{transactionId}": {
      get: {
        ...
        tags: ["transactions", "{transactionId}"],
    ...
    "/transactions/insights/spending-trends": {
      get: {
        ...
        tags: ["transactions", "insights", "spending-trends"],
    ...
    "/investments/portfolios/{portfolioId}/rebalance": {
      post: {
        ...
        tags: ["investments", "portfolios", "{portfolioId}", "rebalance"],
    ...
    "/investments/portfolios/{portfolioId}": {
      get: {
        ...
        tags: ["investments", "portfolios", "{portfolioId}"],
    ...
    "/investments/assets/search": {
      get: {
        ...
        tags: ["investments", "assets", "search"],
    ...
    "/ai/oracle/simulate/advanced": {
      post: {
        ...
        tags: ["ai", "oracle", "simulate", "advanced"],
    ...
    "/ai/incubator/pitch/{pitchId}/details": {
      get: {
        ...
        tags: ["ai", "incubator", "pitch", "{pitchId}", "details"],
    ...
    "/ai/incubator/pitch/{pitchId}/feedback": {
      put: {
        ...
        tags: ["ai", "incubator", "pitch", "{pitchId}", "feedback"],
        ...
        requestBody: {
          content: {
            "application/json": {
              ...
              required: ["lengthSeconds", "prompt", "style"],
              example: {
    ...
    "/ai/ads/operations/{operationId}": {
      get: {
        ...
        tags: ["ai", "ads", "operations", "{operationId}"],
    ...
    "/corporate/cards/{cardId}/controls": {
      put: {
        ...
        tags: ["corporate", "cards", "{cardId}", "controls"],
    ...
    "/corporate/cards/{cardId}/freeze": {
      post: {
        ...
        tags: ["corporate", "cards", "{cardId}", "freeze"],
    ...
    "/corporate/cards/{cardId}/transactions": {
      get: {
        ...
        tags: ["corporate", "cards", "{cardId}", "transactions"],
          ...
          content: {
            "application/json": {
              schema: {
                ...
                required: ["controls", "expirationDate", "holderName", "purpose"],
                example: {
                  holderName: "Marketing Campaign Q4",
                  associatedEmployeeId: "emp_marketing_01",
    ...
    "/corporate/anomalies/{anomalyId}/status": {
      put: {
        ...
        tags: ["corporate", "anomalies", "{anomalyId}", "status"],
    ...
    "/corporate/compliance/audits/{auditId}/report": {
      get: {
        ...
        tags: ["corporate", "compliance", "audits", "{auditId}", "report"],
    ...
    "/corporate/compliance/audits": {
      post: {
        ...
        tags: ["corporate", "compliance", "audits"],
        ...
        requestBody: {
          content: {
            "application/json": {
              ...
              required: ["auditScope", "endDate", "regulatoryFrameworks", "startDate"],
              example: {
    ...
    "/corporate/sanction-screening": {
      post: {
        ...
        tags: ["corporate", "sanction-screening"],
          ...
          content: {
            "application/json": {
              schema: {
                ...
                required: ["country", "entityType", "name"],
                example: {
                  name: "John Doe",
                  country: "US",
    ...
    "/corporate/treasury/cash-flow/forecast": {
      get: {
        ...
        tags: ["corporate", "treasury", "cash-flow", "forecast"],
    ...
    "/corporate/treasury/liquidity-positions": {
      get: {
        ...
        tags: ["corporate", "treasury", "liquidity-positions"],
    ...
    "/corporate/risk/fraud/rules/{ruleId}": {
      put: {
        ...
        tags: ["corporate", "risk", "fraud", "rules", "{ruleId}"],
    ...
    "/corporate/risk/fraud/rules": {
      get: {
        ...
        tags: ["corporate", "risk", "fraud", "rules"],
    ...
    "/web3/wallets/{walletId}/balances": {
      get: {
        ...
        tags: ["web3", "wallets", "{walletId}", "balances"],
    ...
    "/web3/transactions/initiate": {
      post: {
        ...
        tags: ["web3", "transactions", "initiate"],
    ...
    "/payments/international/{paymentId}/status": {
      get: {
        ...
        tags: ["payments", "international", "{paymentId}", "status"],
