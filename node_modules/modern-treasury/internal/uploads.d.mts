...
import type { ModernTreasury } from "../client.mjs";
 ...
 */
export declare const maybeMultipartFormRequestOptions: (opts: RequestOptions, fetch: ModernTreasury | Fetch) => Promise<RequestOptions>;
type MultipartFormRequestOptions = Omit<RequestOptions, 'body'> & {
    body: unknown;
};
export declare const multipartFormRequestOptions: (opts: MultipartFormRequestOptions, fetch: ModernTreasury | Fetch) => Promise<RequestOptions>;
export declare const createForm: <T = Record<string, unknown>>(body: T | undefined, fetch: ModernTreasury | Fetch) => Promise<FormData>;
export {};
