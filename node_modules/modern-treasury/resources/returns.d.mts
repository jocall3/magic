...
export interface ReturnObject {
     ...
     */
    type: 'ach' | 'ach_noc' | 'au_becs' | 'bacs' | 'book' | 'check' | 'cross_border' | 'eft' | 'gb_fps' | 'interac' | 'manual' | 'sepa' | 'wire';
    updated_at: string;
    /**
...
export declare namespace ReturnCreateParams {
    /**
     * Only relevant for ACH NOC returns. This is an object containing all of the new
     * and corrected information provided by the bank that was previously incorrect on
     * the original outgoing payment.
...
export declare namespace Returns {
    export { type ReturnObject as ReturnObject, type ReturnObjectsPage as ReturnObjectsPage, type ReturnCreateParams as ReturnCreateParams, type ReturnListParams as ReturnListParams, };
}
//# sourceMappingURL=returns.d.mts.map