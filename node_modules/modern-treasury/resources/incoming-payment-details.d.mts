...
export declare class IncomingPaymentDetails extends APIResource {
     ...
     */
    createAsync(body?: IncomingPaymentDetailCreateAsyncParams | null | undefined, options?: RequestOptions): APIPromise<Shared.AsyncResponse>;
}
...
export interface IncomingPaymentDetail {
     ...
     */
    originating_account_number_type: 'au_number' | 'base_address' | 'clabe' | 'ethereum_address' | 'hk_number' | 'iban' | 'id_number' | 'nz_number' | 'other' | 'pan' | 'polygon_address' | 'sg_number' | 'solana_address' | 'wallet_address' | null;
    /**
     ...
     * `wire`.
     */
    type: 'ach' | 'au_becs' | 'bacs' | 'book' | 'check' | 'eft' | 'interac' | 'neft' | 'nz_becs' | 'rtp' | 'sepa' | 'signet' | 'wire';
    updated_at: string;
    /**
...
//# sourceMappingURL=incoming-payment-details.d.mts.map