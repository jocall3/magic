...
export declare class LedgerAccountBalanceMonitors extends APIResource {
    /**
...
export declare namespace LedgerAccountBalanceMonitor {
    /**
     * Describes the condition that must be satisfied for the monitor to be triggered.
     */
     ...
     * account lock version.
     */
    interface CurrentLedgerAccountBalanceState {
...
export declare namespace LedgerAccountBalanceMonitorCreateParams {
    /**
     * Describes the condition that must be satisfied for the monitor to be triggered.
     */
    interface AlertCondition {
