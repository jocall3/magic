...
export declare class AccountEntries extends APIResource {
    /**
...
export declare namespace AccountEntries {
    export { type AccountEntryUpdateParams as AccountEntryUpdateParams, type AccountEntryDeleteParams as AccountEntryDeleteParams, };
}
//# sourceMappingURL=account-entries.d.ts.map