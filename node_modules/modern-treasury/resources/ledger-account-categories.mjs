...
export class LedgerAccountCategories extends APIResource {
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/api/ledger_account_categories', (Page), {
            query,
            ...options,
        });
    }
     ...
     * ```
     */
    addLedgerAccount(ledgerAccountID, params, options) {
        const { id } = params;
     ...
     * ```
     */
    addNestedCategory(subCategoryID, params, options) {
        const { id } = params;
     ...
     * ```
     */
    removeLedgerAccount(ledgerAccountID, params, options) {
        const { id } = params;
     ...
     * ```
     */
    removeNestedCategory(subCategoryID, params, options) {
        const { id } = params;
