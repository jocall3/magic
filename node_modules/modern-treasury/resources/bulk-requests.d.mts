...
import * as ExpectedPaymentsAPI from "./expected-payments.mjs";
import * as ExternalAccountsAPI from "./external-accounts.mjs";
import * as Shared from "./shared.mjs";
import * as PaymentOrdersAPI from "./payment-orders/payment-orders.mjs";
import { APIPromise } from "../core/api-promise.mjs";
import { Page, type PageParams, PagePromise } from "../core/pagination.mjs";
import { RequestOptions } from "../internal/request-options.mjs";
export declare class BulkRequests extends APIResource {
    /**
     * create bulk_request
     *
     * @example
...
export declare namespace BulkRequestCreateParams {
    interface PaymentOrderAsyncCreateRequest {
        /**
    ...
    namespace PaymentOrderAsyncCreateRequest {
        /**
         * @deprecated
         */
    ...
    interface ExpectedPaymentCreateRequest {
        /**
    ...
    namespace ExpectedPaymentCreateRequest {
        interface LineItem {
            /**
             * Value in specified currency's smallest unit. e.g. $10 would be represented
             * as 1000.
    ...
    interface TransactionCreateRequest {
         ...
         */
        type?: 'ach' | 'au_becs' | 'bacs' | 'base' | 'book' | 'card' | 'chats' | 'check' | 'cross_border' | 'dk_nets' | 'eft' | 'ethereum' | 'gb_fps' | 'hu_ics' | 'interac' | 'masav' | 'mx_ccen' | 'neft' | 'nics' | 'nz_becs' | 'pl_elixir' | 'polygon' | 'provxchange' | 'ro_sent' | 'rtp' | 'se_bankgirot' | 'sen' | 'sepa' | 'sg_giro' | 'sic' | 'signet' | 'sknbi' | 'solana' | 'wire' | 'zengin' | 'other' | null;
        /**
    ...
    interface PaymentOrderUpdateRequestWithID {
        id?: string;
        /**
         * @deprecated
         */
    ...
    namespace PaymentOrderUpdateRequestWithID {
        /**
         * @deprecated
         */
        interface Accounting {
    ...
    interface ExpectedPaymentUpdateRequestWithID {
        id?: string;
        /**
         * The lowest amount this expected payment may be equal to. Value in specified
         * currency's smallest unit. e.g. $10 would be represented as 1000.
    ...
    interface TransactionUpdateRequestWithID {
        id?: string;
        /**
    ...
    interface LedgerTransactionUpdateRequestWithID {
        id?: string;
        /**
         * An optional description for internal use.
         */
...
export declare namespace BulkRequests {
    export { type BulkRequest as BulkRequest, type BulkRequestsPage as BulkRequestsPage, type BulkRequestCreateParams as BulkRequestCreateParams, type BulkRequestListParams as BulkRequestListParams, };
}
//# sourceMappingURL=bulk-requests.d.mts.map