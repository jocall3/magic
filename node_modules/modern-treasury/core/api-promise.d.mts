...
export declare class APIPromise<T> extends Promise<T> {
    ...
    constructor(client: ModernTreasury, responsePromise: Promise<APIResponseProps>, parseResponse?: (client: ModernTreasury, props: APIResponseProps) => PromiseOrValue<T>);
