...
var reactPlugin_1 = require("../reactPlugin");
function startReactRouterView(routeMatches) {
    (0, reactPlugin_1.onReactPluginInit)(function (configuration, rumPublicApi) {
...
function computeViewName(routeMatches) {
    ...
    for (var _i = 0, routeMatches_1 = routeMatches; _i < routeMatches_1.length; _i++) {
        var routeMatch = routeMatches_1[_i];
        var path = routeMatch.route.path;
        if (!path) {
            continue;
        }
