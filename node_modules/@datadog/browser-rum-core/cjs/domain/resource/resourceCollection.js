...
var identifier_1 = require("../tracing/identifier");
var matchRequestResourceEntry_1 = require("./matchRequestResourceEntry");
...
function processRequest(request, configuration, pageStateHistory) {
    var matchingTiming = (0, matchRequestResourceEntry_1.matchRequestResourceEntry)(request);
...
function processResourceEntry(entry, configuration) {
    ...
    var type = (0, resourceUtils_1.computeResourceEntryType)(entry);
...
function computeResourceEntryMetrics(entry) {
    ...
    return {
        resource: (0, browser_core_1.assign)({
            duration: (0, resourceUtils_1.computeResourceEntryDuration)(entry),
            render_blocking_status: renderBlockingStatus,
        }, (0, resourceUtils_1.computeResourceEntrySize)(entry), (0, resourceUtils_1.computeResourceEntryDetails)(entry)),
    };
}
